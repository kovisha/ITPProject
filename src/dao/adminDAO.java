...
public class adminDAO {
	...
	public  boolean validateAdmin(String userName , String pw)
	{
		...
		return status;
			 ...
			 public static Staff checkAdmin(String username, String password) {
			...
			public static List<CustomerOrder> getAllUsers() throws Exception{
				...
				LocalDate lastOrder = ld.minusMonths(10);
					...
					try { 
					    ...
					    String sql = "SELECT c.ID , c.UserID , c.UName, c.fname , c.lname , c.address , c.email, c.phone, c.dob , o.orderID , o.date, c.loyaltyCardNo , c.loyaltyExpiry, c.loyalyPoints FROM uds_super.customer c, uds_super.order o  WHERE UserID = uid  ORDER BY o.date desc ;" ;
