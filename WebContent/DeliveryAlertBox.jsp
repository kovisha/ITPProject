        ...
        <!--Side Bar header end-->
	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<%if(qOut.equals("successInsertdeliveryType")){ %>
						<script>
							Swal.fire({
								title: 'Delivery Type Inserted Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "AdminDeliveryType.jsp";
								});
						</script>
					<%} %>
					<%if(qOut.equals("failedInsertdeliveryType")){ %>
						<script>
							Swal.fire({
								title: 'Delivery Type Insert Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "AdminDeliveryType.jsp";
								});
					...
					<%if(qOut.equals("successUpdateDeliveryDetails")){ %>
						<script>
							Swal.fire({
								title: 'Delivery Details updated Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "ApointDeliveryStaff.jsp";
								});
						</script>
					<%} %>
					<%if(qOut.equals("failedUpdateDeliveryDetails")){ %>
						<script>
							Swal.fire({
								title: 'Delivery Details update Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "ApointDeliveryStaff.jsp";
								});
					...
					<%if(qOut.equals("successUpdateDeliveryType")){ %>
						<script>
							Swal.fire({
								title: 'Delivery Type Updated Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "AdminDeliveryType.jsp";
								});
					...
					<%} %>
					<%if(qOut.equals("failedUpdateDeliveryType")){ %>
						<script>
							Swal.fire({
								title: 'Delivery Type Update Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "AdminDeliveryType.jsp";
								});
					...
					<%if(qOut.equals("successDeletedeliveryType")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("failedDeletedeliveryType")){ %>
						<script>
							Swal.fire({
