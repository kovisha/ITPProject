...
<html>
	...
	<head>
	    ...
	    <title>Staff Alert Messages</title>
        ...
        <!--Side Bar header end-->
	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<!-- Staff SuccessFull Insert Message -->
					<%if(qOut.equals("StaffInsertSucess")){ %>
						<script>
							Swal.fire({
								title: 'Success',
					...
					<!-- Staff UnsuccessFull Insert Message -->
					<%if(qOut.equals("StaffInsertFail")){ %>
						<script>
							Swal.fire({
								title: '!!!!OOPPSSS!!!Staff Insertion Unsuccessfull',
								text:'Something went wrong',
								icon: 'error',
							}).then(function() {
								window.location = "StaffInsert.jsp";
								});
						</script>
					<%} %>
					...
					<!-- Staff SuccessFull Delete Message -->
					<%if(qOut.equals("StaffDeleteSuccess")){ %>
						<script>
							Swal.fire({
								title: 'Success',
				    ...
				    <!-- Staff UnsuccessFull Delete Message -->
					<%if(qOut.equals("StaffDeleteFail")){ %>
						<script>
							Swal.fire({
								title: '!!!!OOPPSSS!!!Staff Removal Unsuccessfull',
								text:'Something went wrong',
								icon: 'error',
							}).then(function() {
								window.location = "StaffList.jsp";
					...
					<!-- Staff SuccessFull Update Message -->
					<%if(qOut.equals("StaffUpdateSucess")){ %>
						<script>
							Swal.fire({
								title: 'Success',
								...
								window.location = "StaffListServlet";
								});
						</script>
					<%} %>
					
				    <!-- Staff UnsuccessFull Update Message -->
					<%if(qOut.equals("StaffUpdateFail")){ %>
						<script>
							Swal.fire({
								title: '!!!!OOPPSSS!!!   Staff Updated Unsuccessfull',
								text:'Something went wrong',
								icon: 'error',
							}).then(function() {
								window.location = "StaffListServlet";
					...
					<!-- Staff SuccessFull Leave Message -->
					<%if(qOut.equals("StaffLeaveInsertSucess")){ %>
						<script>
							Swal.fire({
								title: 'Success',
								text: 'Staff Leave Successfully Recorded',
								icon: 'success',
							}).then(function() {
								window.location = "StaffLeaveServlet";
					...
					<%} %>
					 ...
					 <!-- Staff UnsuccessFull Leave Message -->
					<%if(qOut.equals("StaffUpdateFail")){ %>
						<script>
							Swal.fire({
								title: '!!!!OOPPSSS!!!   Leave insertion Unsuccessfull',
								text:'Something went wrong',
								icon: 'error',
							}).then(function() {
								window.location = "StaffLeaveServlet";
					...
					<!-- Staff SuccessFull OT Message -->
					<%if(qOut.equals("StaffOTInsertSucess")){ %>
						<script>
							Swal.fire({
								title: 'Success',
								text: 'Staff OT Successfully Recorded',
								icon: 'success',
							}).then(function() {
								window.location = "StaffOTServlet";
					...
					<%} %>
					 ...
					 <!-- Staff UnsuccessFull OT Message -->
					<%if(qOut.equals("StaffOTInsertFail")){ %>
						<script>
							Swal.fire({
								title: '!!!!OOPPSSS!!!  OT insertion Unsuccessfull',
								text:'Something went wrong',
								icon: 'error',
							}).then(function() {
								window.location = "StaffOTServlet";
                    ...
                    <!-- Staff SuccessFull Reinsert Message -->
					<%if(qOut.equals("StaffReinsertSuccess")){ %>
						<script>
							Swal.fire({
								title: 'Success',
								text: 'Staff Successfully Deleted',
				    ...
				    <!-- Staff UnsuccessFull Reinsert Message -->
					<%if(qOut.equals("StaffReinsertFail")){ %>
						<script>
							Swal.fire({
								title: '!!!!OOPPSSS!!!Staff Removal Unsuccessfull',
								text:'Something went wrong',
