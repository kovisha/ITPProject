 ...
 table, td, th {
  ...
  <div class = "container">
		<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
			<div class = "card-body">
					<form action="itemPdf.jsp" method ="post" >
   ...
   <div class="form-group col-md-4"> </div>
   			...
   			<div class = "row-lg-4">				 
					...
					<p class="text-center">Lets Analyze the	Frequently Sold Items in the Store based on the 
					<p class = "text-center">QUANTITY OF ITEM SOLD.	
					</div>
			...
			<div class = "row">				 
					...
					<center><button type="submit" class="btn btn-success btn-block"><i class="fas fa-eye"></i>  VIEW ANALYSIS</button></center>		
					</div>
