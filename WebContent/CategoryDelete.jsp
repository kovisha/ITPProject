...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="categoryName"  placeholder="Name" name = "categoryName"  value = "<%= catName %>" readonly>
 </div>
  ...
  <div class="form-group col-md-4">  </div>
			<div class = "row">				 
					<div class = "form-group col-lg-4">
						...
						<button type="submit" class="btn btn-success btn-block ">Delete Category</button>		
					</div>
			</div>
