	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<div class="container">
    					<div class="row">
        					<div class="col-sm">
            					<form name="retrieveInstall" method="get" action="retrieveInstall">
                					<center><button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-eye"> </i>View Installment Details</button></center>                                            
            					</form>
        					</div>
       
        					<div class="col-sm">
            					<form action="retrieveInstallType" method="get"> 
									<center><button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-eye"> </i>View Installment Types</button></center>
	 							</form>
        					</div>
    					</div>
					</div>	
 					...
 					<table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped">
                        ...
                        <tbody>
                        	<c:forEach var="install" items="${installDetail}">
								<c:set var="id" value="${install.id}"/>
								<c:set var="installmentId" value="${install.installmentId}"/>
								<c:set var="payId" value="${install.payId}"/>
								<c:set var="totAmount" value="${install.totAmount}"/>
								<c:set var="downPay" value="${install.downPay}"/>
								<c:set var="remainInstalls" value="${install.remainInstalls}"/>
								<c:set var="typeId" value="${install.typeId}"/>
                                ...
                                <tr class = "tableRow">
                                    ...
                                    <td class="tr1">
                                   		<c:url value="updateInstallment.jsp" var="installUpdate">
											<c:param name="id" value="${id}"/>
											<c:param name="installmentId" value="${installmentId}"/>
											<c:param name="payId" value="${payId}"/>
											<c:param name="totAmount" value="${totAmount}"/>
											<c:param name="downPay" value="${downPay}"/>
											<c:param name="remainInstalls" value="${remainInstalls}"/>
											<c:param name="typeId" value="${typeId}"/>
										</c:url>
                                   		<div class = "tableRowww">
                                    		<button type="button" class="btn btn-outline-warning btn-sm">
                                    			<a href="${installUpdate}">
                                    ...
                                    <td class="tr1"	>	
                                    	<c:url value="deleteInstallment.jsp" var="installDelete">
											<c:param name="id" value="${id}"/>
											<c:param name="installmentId" value="${installmentId}"/>
											<c:param name="payId" value="${payId}"/>
											<c:param name="totAmount" value="${totAmount}"/>
