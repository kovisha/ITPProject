...
<!--       <form action="adminProgress" method="POST"  >
        <button type="button" class="btn btn-success btn-lg btn-block">Orders On Progress</button>
               ...
               <form method="post" action="itemDelete">
					    <center><h2 style = "color:white">Delete Order</h2></center><br><br/>
					    
						<!--  <label>  Delete Order?</label>
						<center><input type="text" name="id" placeholder="Enter ID" value = ""></center></input><br/><br/>-->
						
						<div class="form-group">
						<center><label for="itemName" style = "color:white"> Confirm Delete ? </label>
                        <input  style = "width:200px"type="text" class="form-control" id="itemName"  placeholder="Name" name = "id" value = "<%= id%>"></input></center>
						</div>
						
					    <center> <input  style = "width:120px" type="submit" name = "submit" value = "Delete"  class="btn btn-success btn-block "> </input> </center>
					</form>
