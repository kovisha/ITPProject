...
<!--  <input type="submit"  value="Click here to view the Categories" >-->
 ...
 <table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped" id="myTable">
                        ...
                        <c:forEach var="category" items="${listCategory}">
      							...
      							<c:set var = "catname" value = "${category.catname}"/>
      							
      							<c:url value = "CategoryDelete.jsp" var = "categorydelete">
								<c:param name="id" value = "${id}"/>
								<c:param name="catname" value = "${catname}"/>
								</c:url>
								
								<c:url value = "CategoryUpdate.jsp" var = "categoryupdate">
								<c:param name="id" value = "${id}"/>
								<c:param name="catname" value = "${catname}"/>
								</c:url>
