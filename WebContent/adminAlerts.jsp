        ...
        <!--Side Bar header end-->
	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<%if(qOut.equals("successCustomerDelete")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("failedCustomerDelete")){ %>
						<script>
							Swal.fire({
								title: 'Customer Delete Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "deleteCustomer.jsp";
								});
						</script>
					<%} %>
					
					
					<%if(qOut.equals("restoreSuccess")){ %>
						<script>
							Swal.fire({
								title: 'Customer Details Restored!!!',
								icon: 'success',
							}).then(function() {
								window.location = "viewDeletedUser.jsp";
								});
						</script>
					<%} %>
					<%if(qOut.equals("restoreFailed")){ %>
						<script>
							Swal.fire({
								title: 'Restore Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "restoreCustomer.jsp";
								});
						</script>
					<%} %>	
