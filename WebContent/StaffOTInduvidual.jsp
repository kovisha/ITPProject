		...
		<div class = "card special-card text-light">
			<div class = "card-body">
					<form action="insertOTStaff" method ="post" >
						...
						<div class="form-group">
						    <label for="ot">Select OT Month(Date)</label>
     						<input type="date" class="form-control" id="ot"  placeholder="Pick date of Birth" name = "ot" required> 
    					  </div>
    					  
    					  
    					  
    					  <div class = "form-group">
    					  				<label for="otHours">Select total number of OT hours</label>
										  <input class="form-control" type="number" id="quantity" name="otHours" min="1" max="72">
							</div>				  
