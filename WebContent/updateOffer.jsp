							...
							<div class = "card-body">
								<form action="updateOffer" method ="post" enctype="multipart/form-data">
									<%
										...
										float discP = Float.parseFloat(request.getParameter("discP"));
										String status = request.getParameter("status");
										double orderMinAmount = Double.parseDouble(request.getParameter("orderMinAmount"));
										double orderMaxAmount = Double.parseDouble(request.getParameter("orderMaxAmount"));
										String image = request.getParameter("image");
									%>
		
			 						<div class="form-group">
			 							<label for="id"> Offer ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer ID" name ="offerId" value="<%=offerId%>" readonly><br>
			 						
			    						<label for="name"> Offer Name</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer Name" name ="name" value="<%=name%>" required><br>
			 							
			 							<label for="desc">Description</label>
										<input type="text" class="form-control" placeholder="Enter Offer Description" id="#" name="desc" value="<%=desc%>"><br>
			 						
			 							<label for="dPerc">Discount Percentage</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter the Discount Percentage for Offer" name="dPerc" value="<%=discP%>" required><br>
			    						...
			    						<div class="row" style="margin-left:0.2%;">
			    							<div class="form-group cal-lg-2">
			    								...
			    								<input type="number" class="form-control" id="#"  placeholder="Minimum Amount" name = "min" value="<%=orderMinAmount%>"><br>
			    							</div>
			    							
			    							<div class="form-group cal-lg-2" style="margin-left:15%;">
			    								<label for="dPerc">Max Amount</label>
			    								<input type="number" class="form-control" id="#"  placeholder="Maximum Amount" name = "max" value="<%=orderMaxAmount%>"><br>
			    							</div>
			    						</div>
			    						...
			    						<input type="file" class="form-control" id="#" onchange="readURL(this);"  placeholder="Insert a Offer Image" name="filename" value="">
			    						
			    						<%-- <c:set var="img" value="sessionScope.<%=offerId%>img"/> --%>

										<!-- Uploaded image area -->
            							<p class="font-italic text-center">The image uploaded will be rendered inside the box below.</p>
            							<div class="image-area mt-4"><img id="imageResult" src="data:image/jpg;base64,<%=image%>" alt="#" class="img-fluid rounded shadow-sm mx-auto d-block" height="80"/></div>
