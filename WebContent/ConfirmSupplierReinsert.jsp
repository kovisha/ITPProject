...
<html>
	...
	<head>
	    ...
	    <title>Confirm Supplier Re-Insert</title>
				...
				<div class = "container">
					...
					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							<div class = "card-body">
								<form action="consupplierRe" method ="post">
									<%
									...
									%>
			 						...
			 						<div class="form-group">
			    						...
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A Supplier Pay ID" name = "name" value="<%= name%>" readonly><br>
