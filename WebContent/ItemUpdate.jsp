...
<div class="form-group"> <!-- Drop downs -->
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="itemName"  placeholder="Name" name = "itemName" value = "<%= itemName %>" >
 </div>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="qty"  placeholder="Quantity" name = "qty"value = "<%= itemQty %>" >
 </div>
