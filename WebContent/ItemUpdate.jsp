 ...
 <%
	...
	%>
		...
		<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
			<div class = "card-body">
					<form action="updateItem" method ="post" name = "itemUpdate">


<div class="form-group"> <!-- Drop downs -->
      <label for="category">CategoryName</label>
      <input type="text" class="form-control" id="itemCategory"  placeholder="Category" name = "catName" value = "<%= itemCategory %>" >
    </div>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="itemName"  placeholder="Name" name = "itemName" onblur = "onlyItemUpdateletter()"  value = "<%= itemName %>" >
 </div>
 
  <div class="form-group">
    <label for="itemSize">Item Size</label>
    <input type="text" class="form-control" id="iSize"  placeholder="Size" name = "iSize" value = "<%= itemSize %>" >
 </div>
 
  <div class="form-group">
    <label for="barcodeID">Barcode ID</label>
    <input type="text" class="form-control" id="barcodeID"  placeholder="Barcode" name = "barcodeID" value = "<%= itembarcode %>" >
 </div>
 
   <div class="form-group">
    <label for="itemPrice">ItemPrice</label>
    <input type="text" class="form-control" id="iPrice"  placeholder="Price" name = "iPrice" value = "<%= itemPrice %>" >
 </div>
 
   <div class="form-group">
    <label for="qtyAvailable">Quantity Available</label>
    <input type="text" class="form-control" id="qty"  placeholder="Quantity" name = "qty"value = "<%= itemQuantity %>" >
 </div>
 
   <div class="form-group">
      <label for="itemStatus"> Item Status</label>
      <select class="form-control input-lg" id="itemstatus" placeholder="Status" name = "itemStatus" value = "<%= itemStatus %>"  >
       <option value = "<%= itemStatus %>" disabled selected hidden><%= itemStatus %></option>
        <option>AV</option>
        <option>UV</option>
      </select>
    </div>
   ...
   <div class="form-group">
      ...
      <input type="text" class="form-control" id="itemOferr"  placeholder="Offer" name = "Offerr" value = "<%= itemOffer %>" >
    </div>  
