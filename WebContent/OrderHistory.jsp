       ...
       <c:forEach var="orderhis" items= "${orderHisto}">
        <tr class="table-success" style="font-weight: bold; font-size: 20px;">
          ...
          <td>
           <script>
                             function myfunction(){
        	                 window.alert("Are you sure you want to Delete order ?");
        	                 }         
               
                             </script>

          <h3><strong>
           <a href = "userorderDelete?id=${orderhis.orderID}">
          <!-- <input onclick="myfunction()" style = "width:100px; height:40px ;" type="button" class="btn btn-success btn-primary btn-block text-center" value = "Delete Order"/> -->
          <center><button type = "submit" id = "mybtn" class="btn btn-outline-danger" style = "font-size: 15px; width : 150px" ><i class="fas fa-trash"></i>&nbsp;Delete Order</button></center>
          </a>
          </strong>
           </h3></td>
