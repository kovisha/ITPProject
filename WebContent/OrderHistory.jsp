...
<body>
  ...
  <div class="header">
    ...
    <div class = "col-sm-8">
      ...
      <tbody>
       <c:forEach var="orderhis" items= "${orderHistory}">
        <tr class="table-success" style="font-weight: bold; font-size: 20px;">
          ...
          <td><button type="button" class="btn btn-success btn-primary btn-block text-center"><p class="h5">Delete</p></button></td>
     ...
     <form action="#" method="POST"  >
        <center><input type="submit"  style = "width : 150px ; height : 50px" type="submit"  value="Continue"  class="btn btn-success btn-lg btn-block"></center>
       </form> <br>
