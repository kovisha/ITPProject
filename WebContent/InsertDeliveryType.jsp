...
<head>
    ...
    <title>Insert New Delivery Type</title>
...
<div class="formHeading">
		<h2 class="text-center">INSERT NEW DELIVERY TYPE</h2>
</div>
                       		...
                       		<li>
                         		<a href="AdminDeliveryType.jsp">
                         			<button class="btn btn-info btn-block btn-sm" style="width:150% ; height: 150%">
                        				<i class="fas fa-eye"></i> View Delivery Types 
                         			</button>
                         		</a>
                         	</li>
                     	</ul>
				...
				<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
					<div class = "card-body">
						...
						<form action="insertNewDelivery" method ="post" name="insertNewDelivery">
							...
							<div class="form-group">
							   <label>Charges</label>
							   <input type="text" class="form-control" id="dCharge"  placeholder="50.00" name = "dCharge" required>
							</div>
