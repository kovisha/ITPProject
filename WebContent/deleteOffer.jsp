				...
				<div class = "container">
					...
					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							<div class = "card-body">
								<form action="deleteOffer" method ="get" enctype="multipart/form-data">
									<%
									...
									%>
			 						...
			 						<div class="form-group">
			    						...
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer ID" name = "id" value="<%=offerId%>" readonly><br>
			 						
			    						<label for="name"> Offer Name</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer Name" name = "name" value="<%=name%>" readonly><br>
			 							
			 							<label for="desc">Description</label>
										<input type="text" class="form-control" id="#"  placeholder="Enter a Offer Description" name = "name" value="<%=desc%>" readonly><br>
			 						
			 							<label for="dPerc">Discount Percentage</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter the Discount Percentage for Offer" name = "dPerc" value="<%=discP%>" readonly><br>
									...
									<!-- 	<c:set var="img" value="sessionScope.img"/> -->
			    						...
			    						<img src="data:image/jpg;base64,<%=image%>" id="#" height="80"/>
			 						</div>
									...
									<div class = "#">				 
										<div class = "form-group col-lg-4">
											<% session.setAttribute("id", offerId); %>
											<button type="submit" class="btn btn-success btn-block ">Confirm Delete</button>		
										</div>
