...
<html>
	...
	<head>
	    ...
	    <title>Display Delivery Details</title>
	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<style>
 					...
 					<form action="AdminDeliveryStaff.jsp" method="post">  
 						<center><button type="submit" class="btn btn-primary btn-lg "><i class="fas fa-eye"> </i>Top Performers</button></center> 
 					...
 					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							<div class = "card-body">
								<form action="DeliveryRateReport.jsp" method ="post" >
