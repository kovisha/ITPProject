...
<html>
	...
	<head>
	    ...
	    <title>Delete Installment Type</title>
	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<div class="formHeading">
						<center>
							<h2>RE-INSERT INSTALLMENT TYPE</h2>
						</center>
					</div>
					...
					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							<div class = "card-body">
								<form action="reInsertInstallType" method ="get">
									<%
									...
									%>
			 						...
			 						<div class="form-group">
			    						...
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer ID" name = "installmentId" value="<%=id%>" readonly><br>
			 						
			    						<label for="payId">Type ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer Name" name = "payId" value="<%=typeId%>" readonly><br>
			 							
			 							<label for="totAmount">Type Description</label>
										<input type="text" class="form-control" id="#"  placeholder="Enter a Offer Name" name = "totAmount" value="<%=tDesc%>" readonly><br>
			 						
			 							<label for="downPay">Months</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter the Discount Percentage for Offer" name = "downPay" value="<%=months%>" readonly><br>
			 						</div>
									...
									<div class = "#">				 
										<div class = "form-group col-lg-4">
											...
											<button type="submit" class="btn btn-success btn-block ">Confirm Re-Insert</button>		
										</div>
