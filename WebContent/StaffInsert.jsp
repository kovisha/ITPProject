		...
		<div class = "card-body">
			<form action="insertStaff" method ="post" enctype="multipart/form-data">
				...
				<div class="form-group">
				    ...
				    <input type="text" class="form-control" id="staffFirstName"  placeholder="Enter First Name" name = "staffFirstName" required>
				 </div>
				 ...
				 <div class = "row">
				 	<div class = "col-md-6">
				 		<div class="form-group">
						    ...
						    <textarea class="form-control" id="staffAddress" name="staffAddress" rows="3" placeholder="Enter address"></textarea>
					  	</div>
				 	</div>
				 	<div class = "col-md-6">
					 	  <div class="form-group">
						    <label for="staffemailAddress">Email address</label>
						    <input type="email" class="form-control" id="staffemailAddress" name="staffemailAddress" placeholder="name@example.com">
						  </div>
				 	</div>
				 </div>	
				 ...
				 <div class = "row">
				 	<div class = "col-md-6">
				 		<div class="form-group">
						    ...
						    <input type="text" class="form-control" id="mobNo"  placeholder="Enter First Name" name = "mobNo" required>
						 </div>
				 	</div>
				 	<div class = "col-md-6">
				 		<div class="form-group">
						    <label for="homNo">Home Number</label>
						    <input type="text" class="form-control" id="homNo"  placeholder="Enter First Name" name = "homNo" >
						 </div>
				 	</div>
				 	...
				 	<div class = "col-md-6">
				 		  <div class="form-group">
						    <label for="dob">Date of birth</label>
     						<input type="date" class="form-control" id="dob"  placeholder="Pick date of Birth" name = "dob" required> 
    					  </div>
				 	</div>
				 	<div class = "col-md-6">
				 		  <div class="form-group">
				 		    ...
				 		    <div class="form-check">
					          <input class="form-check-input" type="radio" name="staffGender" id="staffMale" value="M" checked>
					          <label class="form-check-label" for="staffMale">
					            Male
					          </label>
					        </div>
					        <div class="form-check">
					          <input class="form-check-input" type="radio" name="staffGender" id="staffFemale" value="F">
					          <label class="form-check-label" for="staffFemale">
					            Female
					          </label>
					        </div>
						  </div> 	  
				 ...
				 <div class = "row">
				 	<div class = "col-md-6">
				 		  <div class="form-group">
						    ...
						    <input type="text" class="form-control" name = "staffNIC" id="staffNIC" placeholder="Example the NIC number" pattern="[0-9]{9}[V|v|X|x]|[0-9]{12}">
						  </div>
				 	</div>
				 	<div class = "col-md-6">
