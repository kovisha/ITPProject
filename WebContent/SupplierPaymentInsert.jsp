...
<html>
	<head>
	    ...
	    <title>Supplier Payment Insert</title>
	...
	<body>
      ...
      <nav id="sidebar">
	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<div class="formHeading">
						<center>
							<h2>Insert New Supplier Payment</h2>
						</center>
					</div>
	                            	...
	                            	<ul>
	                                	<li>
	                                		<form action="supplierpayment" method="post"> 
												<center><button type="submit" class="btn btn-primary btn-lg "><i class="fas fa-eye"> </i>View Suppliers Payment</button></center>
					...
					<div class = "container">
						...
						<form action="insertsupplierpayment" method ="post" name = "supplierPaymentInsert" onsubmit="return validateSupplierPaymentForm()" >
								...
								<div class = "row">   
			 						...
			 						<div class="form-group">
			    						<!-- <label for="name"> Supplier Pay ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter The Supplier Pay ID" name = "supplierpayid" required><br> -->
			 							
			 							<!-- <label for="name"> Stock ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter The Stock ID" name = "stockid" required><br> -->
			    						
			    						<label for="name">Stock Name</label>
										<select name="stockid" class="form-control" id="inputSPSname">
											<option value = "-1" >Enter The Stock</option>
											<%	
												try{
													String Query = "select * from stock";
													
													Class.forName("com.mysql.jdbc.Driver").newInstance();
													Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/uds_ex","root","joachim484"); 
													...
													while(rs.next()) {
														%>
														<option value="<%= rs.getString("stockid")%>"><%= rs.getString("stockname") %> - <%= rs.getFloat("stocksize") %></option>
										...
										<select name="discounttype" class="form-control" id="inputSPDtype">
											<option value="discount">discount</option>
											<option value="free">free</option>
										</select><br/>
										
										<label for="name"> Discount Percentage</label>
			    						<input type="text" class="form-control" id="inputSPDper"  placeholder="Enter The Discount Percentage" name = "discountpercentage" ><br>
										
										<label for="name"> Total Amount</label>
			    						<input type="text" class="form-control" id="inputSPTamt"  placeholder="Enter The total amount" name = "totalamount" ><br>
	    ...
	    <script type="text/javascript">
  			function autoFill() {
    			document.getElementById('inputSPSname').value = "STK000001";
    			document.getElementById('inputSPDtype').value = "discount";
    			document.getElementById('inputSPDper').value = "4";
    			document.getElementById('inputSPTamt').value = "4000";
	...
	function validateSupplierPaymentForm() {
		var sn = document.forms["supplierPaymentInsert"]["stockid"].value;
		var s = document.forms["supplierPaymentInsert"]["discounttype"].value;
		var sa = document.forms["supplierPaymentInsert"]["discountpercentage"].value;
		var se = document.forms["supplierPaymentInsert"]["totalamount"].value;
		...
		if(sn =="") {
			...
			alert("Please Provide The Discount Percentage !");
			return false;
		}
		else if(se =="") {
