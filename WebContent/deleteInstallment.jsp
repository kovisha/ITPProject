...
<html>
	...
	<head>
	    ...
	    <title>Delete Installment</title>
				...
				<div class = "container">
					...
					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							<div class = "card-body">
								<form action="deleteInstall" method ="get" enctype="multipart/form-data">
									<%
										String id = request.getParameter("id");
										String installmentId = request.getParameter("installmentId");
										String payId = request.getParameter("payId");
										String totAmount = request.getParameter("totAmount");
										String downPay = request.getParameter("downPay");
										String remainInstalls = request.getParameter("remainInstalls");
										String typeId = request.getParameter("typeId");
									%>
		
			 						<div class="form-group">
			 							<label for="installmentId"> Installment ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer ID" name = "installmentId" value="<%=installmentId%>" readonly><br>
			 						
			    						<label for="payId"> Payment ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer Name" name = "payId" value="<%=payId%>" readonly><br>
			 							
			 							<label for="totAmount">Total Installment Amount</label>
										<input type="text" class="form-control" id="#"  placeholder="Enter a Offer Name" name = "totAmount" value="<%=totAmount%>" readonly><br>
			 						
			 							<label for="downPay">Down Payment</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter the Discount Percentage for Offer" name = "downPay" value="<%=downPay%>" readonly><br>
			    						
										<label for="remainInstalls"> Remaining Installment</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer ID" name = "remainInstalls" value="<%=remainInstalls%>" readonly><br>
			    						
			    						<label for="typeId">Type ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer ID" name = "typeId" value="<%=typeId%>" readonly><br>
			 						</div>
									...
									<div class = "#">				 
										<div class = "form-group col-lg-4">
											<% session.setAttribute("id", installmentId); %>
