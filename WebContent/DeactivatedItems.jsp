...
<%-- <center><button type="submit" class="btn btn-primary btn-lg "><i class="fas fa-eye"> </i>View Notifications</button></center> --%>
...
<center><button type="submit" class="btn btn-primary btn-lg "><i class="fas fa-eye"> </i>View Active Items</button></center>
 </form> 
 <br>
 </div>
 
 <div class = "col-6">
 <form action="viewDeactivatedItems" method="get"> 
<center><button type="submit" class="btn btn-primary btn-lg "><i class="fas fa-eye"> </i>View Deactivated Items</button></center>
 </form> 
 <br>
 </div>
</div>
 ...
 <table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped" id="myTable">
                        <thead>
                        	...
                        	<c:forEach var="deactivated" items="${listDeactivatedItems}">
								
      						
      						<c:set var = "id" value = "${deactivated.catid}"/>
      						<c:set var = "itemName" value = "${deactivated.itemName}"/>
      						<c:set var = "itemSize" value = "${deactivated.itemSize}"/>
      						<c:set var = "itembarcode" value = "${deactivated.barcodeID}"/>
      						<c:set var = "itemPrice" value = "${deactivated.itemPrice}"/>
      						<c:set var = "itemQuantity" value = "${deactivated.availableQty}"/>
      						<c:set var = "itemStatus" value = "${deactivated.status}"/>
      						<c:set var = "itemOffer" value = "${deactivated.offerName}"/>
      						<c:set var = "itemCategory" value = "${deactivated.categoryName}"/>
      						<c:set var = "itemImage" value = "${deactivated.image}"/>
      						
      						
      						<c:url value = "DeactivatedItemDelete.jsp" var = "deactiveitemdelete">
								<c:param name="id" value = "${id}"/>
								<c:param name="itemName" value = "${itemName}"/>
								<c:param name="itemSize" value = "${itemSize}"/>
								<c:param name="itembarcode" value = "${itembarcode}"/>
								<c:param name="itemPrice" value = "${itemPrice}"/>
								<c:param name="itemQuantity" value = "${itemQuantity}"/>
								<c:param name="itemStatus" value = "${itemStatus}"/>
								<c:param name="itemOffer" value = "${itemOffer}"/>
								<c:param name="itemCategory" value = "${itemCategory}"/>
                                 ...
                                 <tr class = "tableRow">
                                    ...
                                    <td>
                                    <div class = "tableRowww">
                                       ${deactivated.itemName}
                                    </div>    
                                    </td>
                                    
                                    <td>
                                    <div class = "tableRowww">
                                       ${deactivated.itemSize}
                                     </div>   
                                    </td>
                                    
                                    <td>
                                    <div class = "tableRowww">
                                      ${deactivated.barcodeID}
                                     </div>   
                                    </td>
                                    
                                    <td>
                                    <div class = "tableRowww">
                                     ${deactivated.itemPrice}
                                     </div>  
                                    </td>
                                    
                                    <td>
                                    <div class = "tableRowww">
                                       ${deactivated.availableQty}
                                     </div>   
                                    </td>
                                    ...
                                    <td>
                                    <div class = "tableRowww">
                                        ${deactivated.offerName}
                                    </div>   
                                    </td>
                                    
                                    <td>
                                    <div class = "tableRowww">
                                      ${deactivated.categoryName}
                                    </div>   
                                    </td>
                                    
                                     <td>
                                      <div class = "tableRowww">
                                       <img src = "data:image/jpg;base64,${deactivated.image}" style="width:100px; height:100px;"><!--specify width = "80" and height = "130"-->
                                    </div>   
                                    </td> 
