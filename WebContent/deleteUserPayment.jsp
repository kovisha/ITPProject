...
<html>
	...
	<head>
	    ...
	    <title>Delete User Payment</title>
				...
				<div class = "container">
					...
					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							<div class = "card-body">
								<form action="deleteUsPay" method ="get">
									<%
									...
									%>
			 						...
			 						<div class="form-group">
			 							<label for="installmentId">Payment ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer ID" name = "installmentId" value="<%=payId%>" readonly><br>
			 						
			    						<label for="payId">Receipt No</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer Name" name = "payId" value="<%=receiptNo%>" readonly><br>
			 							
			 							<label for="totAmount">Payment Type</label>
										<input type="text" class="form-control" id="#"  placeholder="Enter a Offer Name" name = "totAmount" value="<%=paytype%>" readonly><br>
			 						
			 							<label for="downPay">Payment Date</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter the Discount Percentage for Offer" name = "downPay" value="<%=paydate%>" readonly><br>
			    						
										<label for="remainInstalls">Total Bill Amount</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer ID" name = "remainInstalls" value="<%=totAmount%>" readonly><br>
			    						
			    						<label for="typeId">Order ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter a Offer ID" name = "typeId" value="<%=orderId%>" readonly><br>
			 						</div>
