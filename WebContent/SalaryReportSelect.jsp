...
<div class = "container">
		...
		<div class = "card special-card text-light">
			<div class = "card-body">
					<form action="SalaryReport.jsp" method ="post" >
						...
						<select name="month" class="form-control bd-dark" required >
						...
						<div class="form-group col-md-9">
							...
							<select name="year" class="form-control bd-dark" required >
					...
					<div class = "form-group col-lg-4">
						...
						<button  type="submit" name ="updateStaff" value = "Update profile" class="btn-sm btn-primary btn-block "><i class="fas fa-download"></i>Salary Reports</button>
