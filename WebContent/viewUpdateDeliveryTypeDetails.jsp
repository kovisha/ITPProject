...
<head>
    ...
    <title>Update Delivery Type Details</title>
...
<body>
						...
						<c:forEach var="DeliveryTypeDetails" items="${DeliveryTypeDetails}">
		
							<c:set var="id" value="${DeliveryTypeDetails.id}"/>
							<c:set var="typeName" value="${DeliveryTypeDetails.typeName}"/>
							<c:set var="charges" value="${DeliveryTypeDetails.charges}"/>
...
<div class="formHeading">
		<h2 class="text-center">UPDATE DELIVERY TYPE DETAILS</h2>
</div>
                       		...
                       		<li>
                         		<a href="AdminDeliveryType.jsp">
                         			<button class="btn btn-info btn-block btn-sm" style="width:150% ; height: 150%">
                        				<i class="fas fa-eye"></i> View Delivery Type Details 
                         			</button>
                         		</a>
                         	</li>
                     	</ul>
			...
			<div class = "container">
				<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
					<div class = "card-body">
						...
						<form action="updateDeliveryType" method ="post" name="updateDeliveryType">
							
							<div class="form-group">
							   <input type=hidden class="form-control" id="id" value= "${DeliveryTypeDetails.id}"  name = "id" >
							</div>
							
							<div class="form-group">
							   <label>Delivery Type </label>
							   <input type="text" class="form-control" id="dtName" value= "${DeliveryTypeDetails.typeName}"  name = "dtName" disabled>
							</div>
							 
							<div class="form-group">
							   <label>Delivery Charges</label>
							   <input type="text" class="form-control" id="dtCharges" value= "${DeliveryTypeDetails.charges}"  name = "dtCharges" >
							</div>
