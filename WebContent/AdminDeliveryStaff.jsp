              ...
              <div class = "container">
                  <div class = "row">
                     ...
                     <div class = "col-lg-4">
               	    	<ul>
                       		<li>
                         		<form name="viewDeliveryStaffs" method="get" action="viewDeliveryStaffs">
									<button type="submit" value="ViewItems" class="btn btn-info btn-block">
...
<!-- 	        <th>Date Joined</th> -->
    ...
    <tbody>
		<c:forEach var="DeliveryStaffDetails" items="${DeliveryStaffDetails}">    
        	<tr class = "tableRow">
                <td>
                	<div class = "tableRowww">
                    	${DeliveryStaffDetails.SID}
                    </div>    
                </td>
                <td>
                	<div class = "tableRowww">
                    	${DeliveryStaffDetails.name}
                    </div>    
                </td>
                <td>
                	<div class = "tableRowww">
                    	${DeliveryStaffDetails.ordDelivered}
                    </div>    
                </td>
                <td>
                	<div class = "tableRowww">
                    	${DeliveryStaffDetails.totOrdDelivered}
                    </div>    
                </td>
<!--                 <td> -->
<!--                 	<div class = "tableRowww"> -->
<%--                     	${DeliveryStaffDetails.dateJoined} --%>
<!--                     </div>     -->
<!--                 </td> -->
                <td>
                	<div class = "tableRowww">
                    	${DeliveryStaffDetails.rating}
                    </div>    
                </td>
                <td>
                	<div class = "tableRowww">
                    	${DeliveryStaffDetails.avgRating}
                    </div>    
                </td>
                ...
                <!-- <td class="tr1"	>	
                	<div class = "tableRowww">
                    	<button type="button" class="btn btn-outline-danger btn-sm"> 
                        	<a href="#">
                            	<i class="fa fa-times-circle"></i> Disable
                            </a>
                        </button>
                	</div>	
            	</td> -->	
