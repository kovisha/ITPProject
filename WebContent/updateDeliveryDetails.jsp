...
<body>
						...
						<c:forEach var="DeliveryDetails" items="${DeliveryDetails}">
							...
							<c:set var="id" value="${DeliveryDetails.id}"/>
							<c:set var="uID" value="${DeliveryDetails.uID}"/>
							<c:set var="deliveryID" value="${DeliveryDetails.deliveryID}"/>
							<c:set var="orderID" value="${DeliveryDetails.orderID}"/>
							<c:set var="status" value="${DeliveryDetails.status}"/> 
							<c:set var="amount" value= "${DeliveryDetails.amount}"/>
							<c:set var="address" value= "${DeliveryDetails.address}"/>
...
<div class="formHeading">
		<h2 class="text-center">UPDATE DELIVERY DETAILS</h2>
</div>
                  ...
                  <div class = "row">
                     ...
                     <div class = "col-lg-4">
               	    	<ul>
                       		<li>
                         		<a href="ApointDeliveryStaff.jsp">
                         			<button class="btn btn-info btn-block btn-sm" style="width:150% ; height: 150%">
                        				<i class="fas fa-eye"></i> View Delivery Details 
                         			</button>
                         		</a>
                         	</li>
                     	</ul>
			...
			<div class = "container">
				<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
					<div class = "card-body">
						...
						<form action="updateDelivery" method ="post" name="updateDelivery">
							
							<div class="form-group">
<!-- 							   <label>ID</label> -->
							   <input type="hidden" class="form-control" id="id" value= "${DeliveryDetails.id}"  name = "id" >
							</div>
							
							<div class="form-group">
							   <label>Delivery ID</label>
							   <input type="text" class="form-control" id="dID" value= "${DeliveryDetails.deliveryID}"  name = "dID" disabled>
							</div>
							 
							<div class="form-group">
							   <label>Order ID</label>
							   <input type="text" class="form-control" id="oID" var="orderID" value= "${DeliveryDetails.orderID}"  name = "oID" disabled >
							</div>
							
							<div class="form-group">
							   <label>Address</label>
							   <input type="text" class="form-control" id="oadd" var="orderAddress" value= "${DeliveryDetails.address}"  name = "oadd" disabled >
							</div>
							
							<div class="form-group">
							   	<label>Status</label>
								<select class="form-control" id="status" var="status" value= "${DeliveryDetails.status}" name = "status" > 
							...
							<div class="form-group">
		                    	<label for="dob">Delivered Date</label>
		                    	
		                    	<input type="date" class="form-control datepicker-here" data-language = 'en' data-date-format = "yyyy M dd" id="sDate"  name = "delDate">
	                        </div>
							...
							<div class="form-group">
							   ...
							   <input type="text" class="form-control" value= "${DeliveryDetails.amount}" id="amount"  name = "amount" >
							</div>
							 
							<div class="form-group">
							   <label>Staff ID</label>
							   <input type="text" class="form-control" id="uID" value= "${DeliveryDetails.uID}"  name = "uID" >
							</div>										
		</c:forEach>
