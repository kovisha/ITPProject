...
<style>
 ...
 <%
		...
		double itemSize = Double.parseDouble(request.getParameter("itemSize"));
		...
		String itemOffer = request.getParameter("itemOffer");
	...
	%>
		...
		<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
			<div class = "card-body">
					<form action="itemActivate" method ="post" >


<div class="form-group"> <!-- Drop downs -->
      <label for="category">CategoryName</label>
      <input type="text" class="form-control" id="itemCategory"  placeholder="Category" name = "catName" value = "<%= itemCategory %>" readonly>
    </div>
 
 <div class="form-group">
    <label for="itemID"> Item ID</label>
    <input type="text" class="form-control" id="itemID"  placeholder="Name" name = "id" value = "<%= id %>" readonly>
 </div>
 
 
 <div class="form-group">
    <label for="itemName"> Item Name</label>
    <input type="text" class="form-control" id="itemName"  placeholder="Name" name = "itemName" value = "<%= itemName %>" readonly>
 </div>
 
  <div class="form-group">
    <label for="itemSize">Item Size</label>
    <input type="text" class="form-control" id="iSize"  placeholder="Size" name = "iSize" value = "<%= itemSize %>" readonly>
 </div>
 
  <div class="form-group">
    <label for="barcodeID">Barcode ID</label>
    <input type="text" class="form-control" id="barcodeID"  placeholder="Barcode" name = "barcodeID" value = "<%= itembarcode %>" readonly>
 </div>
 
   <div class="form-group">
    <label for="itemPrice">ItemPrice</label>
    <input type="text" class="form-control" id="iPrice"  placeholder="Price" name = "iPrice" value = "<%= itemprice %>" readonly>
 </div>
 
   <div class="form-group">
    <label for="qtyAvailable">Quantity Available</label>
    <input type="text" class="form-control" id="qty"  placeholder="Quantity" name = "qty"value = "<%= itemQty %>" readonly>
 </div>
 
   <div class="form-group">
      <label for="itemStatus"> Item Status</label>
      <select class="form-control input-lg" id="itemstatus" placeholder="Status" name = "itemStatus" value = "<%= itemStatus %>" readonly >
        <option>AV</option>
        <option>UV</option>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="itemOferr"  placeholder="Offer" name = "Offerr" value = "<%= itemOffer %>" readonly>
    </div>
    
    <div class="form-group">
      <label for="offer">Enter Your Password to Confirm Delete!!!</label>
      <input type="password" class="form-control" id="adminPassword"  placeholder="Password" name = "passwrd" >
    </div>
  ...
  <div class="form-group col-md-4">  </div>
			<div class = "row">				 
					<div class = "form-group col-lg-4">
						...
						<button type="submit" class="btn btn-success btn-block ">Activate Item</button>		
					</div>
			</div>
