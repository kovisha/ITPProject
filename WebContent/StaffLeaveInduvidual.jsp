...
<head>
    ...
    <title>Staff Leave Induvidual</title>
		...
		<div class = "card special-card text-light">
			<div class = "card-body">
					<form action="insertLeaveStaff" method ="post" >
						...
						<div class="form-group">
						    <label for="leaveDate">Select Leave Month(Date)</label>
    					  ...
    					  <div class = "form-group">
    					  				<label for="leaveDays">Select total number of Leave days</label>
										  <input class="form-control" type="number" id="quantity" name="leaveDays" min="1" max="72">
							</div>				  
