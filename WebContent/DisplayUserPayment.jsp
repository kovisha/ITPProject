...
<html>
	...
	<head>
	    ...
	    <title>Display User Payment</title>
	        ...
	        <div id="content">
				...
				<div class = "container">
    				...
    				<div class="container">
    					<div class="row">
        					<div class="col-sm">
            					<form name="viewInstallmentTypes" method="get" action="retrieveUsPay">
                					<button type="submit" value="ViewType" class="btn btn-info btn-block">
                    				 	View User Payment  <i class="fas fa-eye"></i>
                					</button>                                            
            					</form>
        					</div>
 					...
 					<table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped">
                        ...
                        <tbody>
                        	<c:forEach var="userPay" items="${uPayDetail}">
								<c:set var="id" value="${userPay.id}"/>
								<c:set var="payId" value="${userPay.payId}"/>
								<c:set var="receiptNo" value="${userPay.receiptNo}"/>
								<c:set var="paytype" value="${userPay.paytype}"/>
								<c:set var="paydate" value="${userPay.paydate}"/>
								<c:set var="totAmount" value="${userPay.totAmount}"/>
								<c:set var="orderId" value="${userPay.orderId}"/>
                                ...
                                <tr class = "tableRow">
                                    ...
                                    <td class="tr1"	>	
                                    	<c:url value="deleteUserPayment.jsp" var="userPaymentDelete">
											<c:param name="id" value="${id}"/>
											<c:param name="payId" value="${payId}"/>
											<c:param name="receiptNo" value="${receiptNo}"/>
											<c:param name="paytype" value="${paytype}"/>
											<c:param name="paydate" value="${paydate}"/>
											<c:param name="totAmount" value="${totAmount}"/>
											<c:param name="orderId" value="${orderId}"/>
										</c:url>
                                    	<div class = "tableRowww">
                                    		<button type="button" class="btn btn-outline-danger btn-sm"> 
                                    			<a href="${userPaymentDelete}">
