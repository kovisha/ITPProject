...
<html>
	...
	<head>
	    ...
	    <title>Additional Payment Details</title>
							...
							<div class = "card-body">
								<form>
									<%
										...
										float discpercent = Float.parseFloat(request.getParameter("discpercent"));
									...
									%>
			 						...
			 						<div class="form-group">
			    						...
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A Supplier Pay ID"  value="<%= stockid%>" readonly><br>
			 					
			 							<label for="id"> Discount Type</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A Supplier Pay ID"  value="<%= type%>" readonly><br>
			 					
			 							<label for="id"> Discount Percent</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A Supplier Pay ID"  value="<%= discpercent%>" readonly><br>
			    						
			 							<label for="id"> Total Amount</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A Supplier Pay ID"  value="<%= totalAmount%>" readonly><br>
			 					
			    						<label for="chequenumber"> Cheque Number</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter The Cheque Number"  value="<%= chequeNo%>" readonly><br>
										
										<label for="payamount"> Paid Amount</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter Payment Amount"  value="<%= paidAmount%>" readonly><br>
									...
									<div class = "#">				 
										<div class = "form-group col-lg-4">
											<a href><i></i></a>
											<button type="submit" class="btn btn-success btn-block "><a href="ViewSupplierPayment.jsp"><i></i>Return Back</a></button>		
										</div>
