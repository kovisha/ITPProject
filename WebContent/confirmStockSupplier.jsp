...
<html>
	<head>
	    ...
	    <title>Confirm Stock Supplier</title>
					...
					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							...
							<!-- <div class="form-group col-md-4">  </div>
								...
								<form action="viewSupplierStockServlet" method ="post"  name = "supplierInsert" onsubmit="return validateSupplierInsertForm()">
								...
								%>
			 						...
			 						<div class="form-group">
			    						...
			    						<input type="text" class="form-control" id="inputSName"  placeholder="Enter the Supplier Name" name = "suppliername" value="<%=id%>"><br>
			 					
			 						</div>

	 								<br>
										<div class = "form-group ">
											<button type="submit" class="btn btn-success btn-block ">View The Stocks Supplied</button>
										</div>
