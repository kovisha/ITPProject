...
<html>
	...
	<head>
	    ...
	    <title>Alert Box Supplier</title>
        ...
        <!--Side Bar header end-->
	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<%if(qOut.equals("successInsertSupplier")){ %>
						<script>
							Swal.fire({
								title: 'Supplier Inserted Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "ViewSupplier.jsp";
								});
						</script>
					<%} %>
					<%if(qOut.equals("failedInsertSupplier")){ %>
						<script>
							Swal.fire({
								title: 'Supplier Insert Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "ViewSupplier.jsp";
								});
					...
					<%if(qOut.equals("successUpdateSupplier")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("failedUpdateSupplier")){ %>
						<script>
							Swal.fire({
					...
					<%if(qOut.equals("successDeleteSupplier")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("failedDeleteSupplier")){ %>
						<script>
							Swal.fire({
								title: 'Supplier Delete Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "ViewSupplier.jsp";
								});
					...
					<%if(qOut.equals("successInsertSupplierPayment")){ %>
						<script>
							Swal.fire({
								title: 'Supplier Payment Method Inserted Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "ViewSupplierPayment.jsp";
								});
						</script>
					<%} %>
					<%if(qOut.equals("failedInsertSupplierPayment")){ %>
						<script>
							Swal.fire({
								title: 'Supplier Payemnt Method Insert Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "ViewSupplierPayment.jsp";
								});
					...
					<%if(qOut.equals("successUpdateSupplierPayment")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("failedUpdateSupplierPayment")){ %>
						<script>
							Swal.fire({
								title: 'Payemnt Insert Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "ViewSupplierPayment.jsp";
								});
					...
					<%if(qOut.equals("successDeleteSupplierPayment")){ %>
						<script>
							Swal.fire({
								title: 'This Payment Deleted Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "ViewSupplierPayment.jsp";
								});
					...
					<%} %>
					<%if(qOut.equals("failedDeleteSupplierPayment")){ %>
						<script>
							Swal.fire({
								title: 'This Payment Delete Successfully!!!',
								icon: 'error',
							}).then(function() {
								window.location = "ViewSupplierPayment.jsp";
								});
