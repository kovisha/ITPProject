...
<center><button type="submit" class="btn btn-primary btn-lg "><i class="fas fa-eye"> </i>View Deleted Users</button></center>
 ...
 <table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped" id="myTable">
                        ...
                        <c:forEach var="custDetail" items="${custDetail}">
                                ...
                                <tr class = "tableRow">
                                   ...
                                   <c:url value="restoreCustomer.jsp" var="custOrder">
