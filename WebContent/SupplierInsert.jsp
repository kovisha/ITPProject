...
<html>
	...
	<body>
      ...
      <nav id="sidebar">
							...
							<!-- <div class="form-group col-md-4">  </div>
									<div class = "row">				 
										<div class = "form-group col-lg-4">
											<button type="submit" class="btn btn-secondary btn-block "onClick="autoFill(); return true;" >Demo Button</button>		
										</div>
										</div> -->
										
					<form action="insertsupplier" method ="post"  name = "supplierInsert" onsubmit="return validateSupplierInsertForm()">
				 				...
				 				<div class = "col-lg-6"></div>            
				                    ...
				                    <center><button type="submit" class="btn btn-secondary btn-block" style="width:150% ; height: 150%"><a href="#" onClick="autoFill(); return true;"> Demo
			 						...
			 						<div class="form-group">
			    						...
			    						<input type="text" class="form-control" id="inputSName"  placeholder="Enter the Supplier Name" name = "suppliername" ><br>
			 						
			 					
			    						<label for="status">Status</label>
										<select name="status" class="form-control" id="inputSStatus">
											<option value="enabled">enabled</option>
											<option value="disabled">disabled</option>
										</select><br/>
										
										<label for="desc">Supplier Address</label>
										<textarea class="form-control" placeholder="Enter The Address" id="inputSAddress" name="supplieraddress"></textarea><br>
										
										<label for="name"> Supplier Email</label>
			    						<input type="text" class="form-control" id="inputSEmail"  placeholder="Enter the Supplier Email" name = "supplieremail" ><br>
										
										<label for="name"> Supplier Phone Number</label>
			    						<input type="text" class="form-control" id="inputSPhone1"  placeholder="Enter the Phone Number" name = "supplierphone1" pattern="[0-9]{10,10}"><br>
										
										<label for="name"> Other Phone Number</label>
			    						<input type="text" class="form-control" id="inputSPhone2"  placeholder="Enter the Phone Number" name = "supplierphone2" pattern="[0-9]{10,10}"><br>
										
										<label for="desc">Description</label>
										<textarea class="form-control" placeholder="Enter The Discription" id="inputSDescription" name="description"></textarea><br>
	    ...
	    <script type="text/javascript">
  			function autoFill() {
    			document.getElementById('inputSName').value = "Nestle";
    			document.getElementById('inputSStatus').value = "enabled";
    			document.getElementById('inputSAddress').value = "58/5,Colombo04";
    			document.getElementById('inputSEmail').value = "nestlesl@gmail.com";
    			document.getElementById('inputSPhone1').value = "0779999999";
    			document.getElementById('inputSPhone2').value = "";
    			document.getElementById('inputSDescription').value = "noodles only";
	...
	function validateSupplierInsertForm() {
		var sn = document.forms["supplierInsert"]["suppliername"].value;
		var s = document.forms["supplierInsert"]["status"].value;
		var sa = document.forms["supplierInsert"]["supplieraddress"].value;
		var se = document.forms["supplierInsert"]["supplieremail"].value;
		var spo = document.forms["supplierInsert"]["supplierphone1"].value;
		//var spt = document.forms["supplierInsert"]["supplierphone2"].value;
		var sd = document.forms["supplierInsert"]["description"].value;
		if(sn =="") {
			alert("Please provide the Supplier Name!");
			return false;
		}
		else if(s =="") {
			...
			alert("Please provide the Supplier Address!");
			return false;
		}
		else if(se =="") {
			alert("Please provide the Supplier Email!");
			return false;
		}
		else if(spo =="") {
			alert("Please provide the Supplier Number!");
			return false;
		}
		/* else if(spt =="") {
			alert("Please provide the Alternate Number!");
			return false;
		} */
		else if(sd =="") {
			alert("Please provide the Supplier Description!");
			return false;
		}
		/*  else if(spo.length == "10" ) {
