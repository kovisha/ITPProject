...
<html>
	...
	<head>
	    ...
	    <title>View Supplier Payments</title>
	        ...
	        <div id="content">
	         		...
	         		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
	  				...
	  				<div class="collapse navbar-collapse" id="navbarSupportedContent">
	    				...
	    				<form class="form-inline my-2 my-lg-0">
	      					<input class="form-control mr-sm-2" type="text" placeholder="Search" id="myInput1" onkeyup="myFunction1()" aria-label="Search">
				...
				<div class = "container">
					...
					<form action="supplierpayment" method="post"> 
 					...
 					<table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped" id="myTable1">
                    	<thead>
                        	<tr>
                            	<th>Pay ID</th>
                                <th>Supplier</th>
                        ...
                        <tbody>
                        	<c:forEach var="supplierpayment" items="${supplierPaymentDetails}">
								...
								<c:set var="suppliername" value="${supplierpayment.suppliername}"/>
								<c:set var="stockname" value="${supplierpayment.stockname}"/>
								<c:set var="stocksize" value="${supplierpayment.stocksize}"/>
								<c:set var="supplieddate" value="${supplierpayment.supplieddate}"/>
								...
								<c:set var="chequeNo" value="${supplierpayment.chequeNo}"/>
								<c:set var="paidAmount" value="${supplierpayment.paidAmount}"/>
								<c:set var="discID" value="${supplierpayment.discID}"/>
								

                                <tr class = "tableRow">
                                    <td>
                                    	<div class = "tableRowww">
											${supplierpayment.suppPayID}
										</div>	
                                    </td>
                                    <td>
                                    	<div class = "tableRowww">
                                    ...
                                    <td>
                                    	<div class = "tableRowww">
                                       		${supplierpayment.stockname}
                                    	</div>    
                                    </td>
                                    <td>
                                    	<div class = "tableRowww">
                                       		${supplierpayment.stocksize}
                                    	</div>    
                                    </td>
                                    <td>
                                    	<div class = "tableRowww">
                                       		${supplierpayment.supplieddate}
                                    	</div>    
                                    </td>
                                    <td>
                                    	<div class = "tableRowww">
                                       		${supplierpayment.invoiceNo}
                                    	</div>    
                                    </td>
                                    <td>
                                    	<div class = "tableRowww">
                                       		${supplierpayment.lastPayDate}
                                    	</div>    
                                    </td>
                                    <td>
                                    	<div class = "tableRowww">
                                       		${supplierpayment.netAmount}
                                    	</div>    
                                    </td>
                                    <td>
                                    	<div class = "tableRowww">
                                       		${supplierpayment.dueAmount}
                                    	</div>    
                                    </td>
                                    
                                    <td class="tr1">
									<c:url value="AdditionalPaymentDetails.jsp" var="viewAdditionalPayment">  
										<c:param name="suppPayID" value="${suppPayID}"/> 
										<c:param name="stockid" value="${stockid}"/> 
										<c:param name="type" value="${type}"/> 
										<c:param name="discpercent" value="${discpercent}"/> 
										<c:param name="totalAmount" value="${totalAmount}"/> 
										<c:param name="chequeNo" value="${chequeNo}"/> 
										<c:param name="paidAmount" value="${paidAmount}"/> 
									
									</c:url> 
                                   		<div class = "tableRowww">
                                    		<button type="button" class="btn btn-outline-success btn-sm">
                                    			<a href="${viewAdditionalPayment}">
									...
									<c:url value="SupplierPayNowInsert.jsp" var="supplierpaynow">  
										<c:param name="suppPayID" value="${suppPayID}"/> 
										<c:param name="lastPayDate" value="${lastPayDate}"/> 
										<c:param name="chequeNo" value="${chequeNo}"/> 
										<c:param name="paidAmount" value="${paidAmount}"/> 
										<c:param name="invoiceNo" value="${invoiceNo}"/> 
										
									</c:url> 
                                   		<div class = "tableRowww">
                                    		<button type="button" class="btn btn-outline-warning btn-sm">
                                    			<a href="${supplierpaynow}">
                                     				<i class="fas fa-edit"></i> Pay Supplier
                                    			</a> 
                                    		</button>
                                    		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    	</div>
