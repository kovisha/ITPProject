...
<html>
	...
	<head>
	    ...
	    <title>Insert New Installment Types</title>
	...
	<body>
	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<div class="formHeading">
						<center>
							<h2>INSERT NEW INSTALLMENT TYPES</h2>
						</center>
					</div>
					...
					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							<div class = "card-body">
								<form action="insertInstallType" method ="post">
									<div class = "row">  
			 						...
			 						<div class="form-group">
			 							<label for="desc">Installment Type Description</label>
										<textarea class="form-control" placeholder="Enter Type Description" id="tyDesc" name="desc"></textarea><br>
			 						
			 							<label for="months">Months</label>
			    						<input type="text" class="form-control" id="months"  placeholder="Enter Installment Type Months" name ="months" required pattern="[0-9]{1,2}" required><br>
			 						</div>
	    ...
	    <script type="text/javascript">
			function autoFill() {
				document.getElementById('tyDesc').value = "Valid for 5 months";
