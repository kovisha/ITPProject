							...
							<div class = "card-body">
								<form action="insertInstallType" method ="post">
			 						...
			 						<div class="form-group">
										...
										<textarea class="form-control" placeholder="Enter Type Description" id="#" name="desc"></textarea><br>
			 						
			 							<label for="months">Months</label>
			    						<input type="text" class="form-control" id="months"  placeholder="Enter Installment Type Months" name ="months" required><br>
			 						</div>
