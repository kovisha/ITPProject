...
<form action="viewActiveUserServlet" method="post"> 
<center><button type="submit" class="btn btn-primary btn-lg "><i class="fas fa-eye"> </i>View Customers</button></center>
<!--  <input type="submit"  value="Click here to view the Categories" >-->
 ...
 <table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped">
                        ...
                        <c:forEach var="custDetail" items="${custDetail}">
...
<!--                                     </td> -->
                                    ...
                                    <td>
                                    <div class = "tableRowww">
										  ${custDetail.orderDate}
									</div>	
                                    </td>
                                    <td>
                                    <div class = "tableRowww">
										  ${custDetail.loyaltyCardNo}
									</div>	
                                    </td>
                                    <td>
                                    <div class = "tableRowww">
										  ${custDetail.loyaltyExpiry}
									</div>	
                                    </td>
                                    <td>
                                    <div class = "tableRowww">
										  ${custDetail.loyaltyPoints}
									</div>	
                                    </td>
                                    
                                    
                                  
                                    <c:set var="ID" value="${custDetail.userID}"/>
                                    <c:set var="uName" value="${custDetail.uName}"/>
                                    
                                   <c:url value="deleteCustomer.jsp" var="custOrder">
