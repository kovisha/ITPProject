...
<html>
	<head>
	    ...
	    <title>Supplier Pay Now Delete</title>
								...
								<form action="deletesupplierpayment" method ="post">
									...
									%>
			 						...
			 						<div class="form-group">
			    						...
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A Stock ID" name = "stockid" value="<%= stockid%>" readonly><br>
			 						
			 							<label for="dPerc">Total Amount</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter The Total Amount" name = "totalAmount" value="<%= totalAmount%>" readonly><br>
			    						
			    						<label for="name"> Payed Amount</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A Stock ID" name = "paidAmount" value="<%= paidAmount%>" readonly><br>
