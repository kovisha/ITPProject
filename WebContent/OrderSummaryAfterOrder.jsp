...
<div class="row">
     ...
     <!--   <form class="card p-2">
      ...
      <br><br> <br><br> <br><br> <br><br>
       <div class= "col" align = "right">
                <button onclick = "location.href='selectPayType.jsp' " type="button"class="btn btn-secondary btn-block"><center><p style="width: 80px; height : 15px ;font-size: 15px; font-family: Georgia;"><i class="fas fa-shopping-cart"></i>Check out</p></center></button>
            </div>
    </div>
             ...
             <!--     <c:set var="netTotal" value="{0}"/>-->
         	   ...
         	   <c:set var = "discount" value ="${cart.discount}"/>
                 ...
                 <tr class="table-light" style="font-weight: bold; font-size: 20px;">
                  ...
                  <c:url value = "updateCartItem.jsp" var = "cartupdate">
                   ...
                   <div class= "col" align = "right">
               		<button type = "submit" class="btn btn-outline-warning" style = "font-size: 12px; width : 120px" disabled> <i class="fa fa-edit"></i>&nbsp;change quantity</button>
               ...
               <!-- <center><p style="width: 80px; height : 15px ;font-size: 15px; font-family: Georgia;"><i class="fas fa-shopping-cart"></i>Update</p></center> -->
                  ...
                  <!--<div>
                   ...
                   <button type = "submit" onclick="myFunction()" class="btn btn-outline-danger" style = "font-size: 12px; width : 100px" disabled><i class="fa fa-trash-alt"></i>&nbsp;Delete Item</button>
                  </a>
                   </div>
                   </p></td>
    ...
    <center><button type = "submit" id = "mybtn" onclick="confirmOrder()" class="btn btn-outline-primary" style = "font-size: 15px; width : 150px" disabled><i class="fa fa-check-circle"></i>&nbsp;PLACE ORDER</button></center>
        </a>
          ...
          <td></td>
           <td></td>
                ...
                <tr   class="table-light" style="font-weight: bold; font-size: 13px;">
                 ...
                 <center><button type = "submit" id = "mybtn" class="btn btn-outline-success" style = "font-size: 15px; width : 150px" disabled ><i class="fas fa-plus"></i>&nbsp;Add Items</button></center>
                 </a>
