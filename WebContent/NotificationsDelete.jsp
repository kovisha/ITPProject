...
<style>
 ...
 table, td, th {
 	...
 	<%
		...
		String reshelfDate = request.getParameter("reshelfDate");
		...
		int reshelfQty =Integer.parseInt(request.getParameter("reshelfQty"));
	...
	%>
		...
		<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
			<div class = "card-body">
					<form action="deleteNotifications" method ="post" >



    
 <div class="form-group">
    <label for="stockID"> Notification ID</label>
    <input type="text" class="form-control" id="notifyID"  placeholder="ID" name = "id" value = "<%= id %>" readonly>
 </div>  
 ...
 <div class="form-group">
    <label for="supDate">ReShelf Date</label>
    <input type="date" class="form-control datepicker-here" data-language = 'en' data-date-format = "yyyy M dd" id="supDate"  placeholder="Reshelf Date" name = "reshelfDate" value = "<%= reshelfDate %>" readonly>
 </div>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <label for="reshelfQty">Reshelf Quantity </label>
    <input type="text" class="form-control" id="reshlefQty"  placeholder="Reshelf Quantity" name = "reshelfQty" value = "<%= reshelfQty %>" readonly>
 </div>
  ...
  <div class="form-group col-md-4">  </div>
			<div class = "row">				 
					<div class = "form-group col-lg-4">
						...
						<button type="submit" class="btn btn-success btn-block ">Delete Notification</button>		
					</div>
			</div>
