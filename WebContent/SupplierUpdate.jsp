...
<html>
				...
				<div class = "container">
					...
					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							<div class = "card-body">
								<form action="updatesupplier" method ="post" name = "supplierUpdateV" onsubmit="return validateSupplierUpdateForm()">
									<%
									...
									%>
			 						...
			 						<div class="form-group">
			    						...
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A Supplier Pay ID" name = "supplierID" value="<%= supplierID%>" readonly><br>
			 						
			    						<label for="name"> Supplier Name</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A The Supplier Name" name = "name" value="<%= name%>" ><br>
										...
										<input type="text" class="form-control" id="#"  placeholder="Enter The Address" name = "address" value="<%= address%>"><br>
			    						
			    						<label for="email"> Supplier Email</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A The Email" name = "email" value="<%= email%>"><br>
										
										<label for="phone1"> Supplier Phone Number</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter Phone Number" name = "phone1" value="<%= phone1%>" pattern="[0-9]{10,10}"><br>
										
										<label for="phone2"> Other Phone Number</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter The Other Number" name = "phone2" value="<%= phone2%>" pattern="[0-9]{10,10}"><br>
										
										<label for="desc">Description</label>
										<input type="text" class="form-control" id="#"  placeholder="Enter The Description" name = "description" value="<%= description%>"><br>
	...
	function validateSupplierUpdateForm() {
		var nu = document.forms["supplierUpdateV"]["name"].value;
		var su = document.forms["supplierUpdateV"]["status"].value;
		var au = document.forms["supplierUpdateV"]["address"].value;
		var eu = document.forms["supplierUpdateV"]["email"].value;
		var pu = document.forms["supplierUpdateV"]["phone1"].value;
		//var spt = document.forms["supplierInsert"]["phone2"].value;
		var du = document.forms["supplierUpdateV"]["description"].value;
		if(nu =="") {
