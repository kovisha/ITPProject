...
<body style="min-width: auto; z-index: 99; position: absolute; ">
...
<style>
 ...
 <form action="viewStockDetails" method="post"> 
<center><button type="submit" class="btn btn-primary btn-lg "><i class="fas fa-eye"> </i>View Stock</button></center>
 ...
 <table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped" id="myTable">
                        <thead>
							...
							<c:set var = "id" value = "${stock.id}"/>
      						...
      						<c:set var = "stockImage" value = "${stock.image}"/>
      						
      					
      						<c:url value = "StockDelete.jsp" var = "stockdelete">
								<c:param name="id" value = "${id}"/>
								<c:param name="stockName" value = "${stockName}"/>
								<c:param name="qtySupplied" value = "${qtySupplied}"/>
								<c:param name="suppliedDate" value = "${suppliedDate}"/>
								<c:param name="stockSize" value = "${stockSize}"/>
								<c:param name="reOrderLevel" value = "${reOrderLevel}"/>
								<c:param name="storeQty" value = "${storeQty}"/>
								<c:param name="supplierName" value = "${supplierName}"/>
								<c:param name="categoryName" value = "${categoryName}"/>
								<c:param name="qtyAvailable" value = "${qtyAvailable}"/>
							</c:url>
								
							<c:url value = "StockUpdate.jsp" var = "stockupdate">
								<c:param name="id" value = "${id}"/>
								<c:param name="stockName" value = "${stockName}"/>
								<c:param name="qtySupplied" value = "${qtySupplied}"/>
								<c:param name="suppliedDate" value = "${suppliedDate}"/>
                                ...
                                <tr class = "tableRow">
                                    ...
                                    <td>
                                    <div class = "tableRowww">
                                       <img src = "data:image/jpg;base64,${stock.image}" style="width:100px; height:100px;"><!--specify width = "80" and height = "130"-->
                                    </div>   
                                    </td>
...
<button type="submit" class="btn btn-info btn-block">
	<a href="insertNewStock.jsp">Add Stock</a>
</button>
