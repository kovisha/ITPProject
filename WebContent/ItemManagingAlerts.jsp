...
<html>
	...
	<head>
	    ...
	    <title>Item Management Alerts</title>
        ...
        <!--Side Bar end--> 
	        ...
	        <div id="content">
				...
				<div class = "container">
					...
					<%if(qOut.equals("successInsertCategory")){ %>
						<script>
							Swal.fire({
								title: 'Category Inserted Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "ViewCategory.jsp";
								});
						</script>
					<%} %>
					<%if(qOut.equals("failInsertCategory")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("successUpdateCategory")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("failUpdateCategory")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("successDeleteCategory")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("failDeleteCategory")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("successInsertItem")){ %>
						<script>
							Swal.fire({
								title: 'Item Inserted Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "ViewItems.jsp";
								});
						</script>
					<%} %>
					<%if(qOut.equals("failInsertItem")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("successUpdateItem")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("successDeleteItem")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("failDeleteItem")){ %>
						<script>
							Swal.fire({
								title: 'Item Deactivation Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "ViewItems.jsp";
								});
					...
					<%if(qOut.equals("successActivateItem")){ %>
						<script>
							Swal.fire({
								title: 'Item Activated Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "DeactivatedItems.jsp";
								});
						</script>
					<%} %>
					<%if(qOut.equals("failActivateItem")){ %>
						<script>
							Swal.fire({
								title: 'Item Activation Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "DeactivatedItems.jsp";
								});
					...
					<%if(qOut.equals("successInsertStock")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("failInsertStock")){ %>
						<script>
							Swal.fire({
								title: 'Stock insert Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "ViewStock.jsp";
								});
					...
					<%if(qOut.equals("dismissNotifySuccess")){ %>
						<script>
							Swal.fire({
								title: 'Notification dismissed Successfully!!!',
								icon: 'success',
							}).then(function() {
								window.location = "StockNotify.jsp";
								});
						</script>
					<%} %>
					<%if(qOut.equals("dismissNotifyFail")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("updateStockSuccess")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("updateStockFail")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("deleteStockSuccess")){ %>
						<script>
							Swal.fire({
					...
					<%} %>
					<%if(qOut.equals("deleteStockFail")){ %>
						<script>
							Swal.fire({
								title: 'Stock Delete Failed!!!',
								icon: 'error',
							}).then(function() {
								window.location = "ViewStock.jsp";
								});
