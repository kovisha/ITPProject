...
<head>
    ...
    <title>ADMIN Delivery Type</title>
...
<div class="container">
	<div class="row">
		<div class="col-sm">
			<form name="viewDeliveryTypes" method="get" action="viewDelivery">
...
<table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped">
    ...
    <tbody>
		<c:forEach var="deliveryType" items="${deliveryDetail}">    
        	<tr class = "tableRow">
            	<td>
				...
				<td class="tr1">
	            	<div class = "tableRowww">
	                	<button type="button" class="btn btn-outline-warning btn-sm">
	                    	<a href="DeliveryTypeUpdate?DTID=${deliveryType.id}">
                ...
                <td class="tr1"	>	
                	<div class = "tableRowww">
                    	<button type="button" class="btn btn-outline-danger btn-sm"> 
                        	<a href="DeliveryTypeDelete?DTID=${deliveryType.id}">
