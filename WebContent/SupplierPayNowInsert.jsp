...
<html>
	...
	<head>
	    ...
	    <title>Supplier Pay Now Insert</title>
				...
				<div class = "container">
					...
					<div class = "container">
						<div class = "card text-light special-card mb-3">  <!--Outer form grid -->
							<div class = "card-body">
								<form action="insertsupplierpaynow" method ="post"  name = "supplierPayInsert" onsubmit="return validateSupplierPayForm()">
									<%
										String suppPayID = request.getParameter("suppPayID"); 
										String lastPayDate = request.getParameter("lastPayDate"); 
									...
									%>
			 						...
			 						<div class="form-group">
			 							...
			 							<label for="id"> Supplier Pay ID</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter A Supplier Pay ID" name = "suppPayID" value="<%= suppPayID%>" readonly><br>
			 						
			    						<%-- <label for="payingdate"> Paying Date</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter The Paying Date" name = "payingdate" value="<%= lastPayDate%>"><br> --%>
			    						
			    						
										<label for="payingdate"> Paying Date</label>						
    									<input type="date" class="form-control datepicker-here" data-language = 'en' data-date-format = "yyyy M dd" id="sDate"  placeholder="Enter The Paying Date" name = "payingdate" value="<%= lastPayDate%>">
										
			    						<label for="chequenumber"> Cheque Number</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter The Cheque Number" name = "chequenumber" value="<%= chequeNo%>"><br>
										
										<label for="payamount"> Payment Amount</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter Payment Amount" name = "payamount" value="<%= paidAmount%>"><br>
										
										<label for="invoicenumber"> Invoice Number</label>
			    						<input type="text" class="form-control" id="#"  placeholder="Enter The Invoice Number" name = "invoicenumber" value="<%= invoiceNo%>"><br>
	...
	function validateSupplierPayForm() {
		var sn = document.forms["supplierPayInsert"]["payingdate"].value;
		var s = document.forms["supplierPayInsert"]["payamount"].value;
		var sa = document.forms["supplierPayInsert"]["invoicenumber"].value;
		
		
		if(sn =="") {
			alert("Please Select The Paying Date!");
			return false;
		}
		else if(s =="") {
			alert("Please Provide The Paying Amount!");
			return false;
		}
		else if(sa =="") {
