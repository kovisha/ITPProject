				...
				<div class = "container">
					...
					<div class="container">
 					...
 					<table class="table table table-hover table-dark table-bordered table-sm text-center table-stripped" id="offerTable">
                        ...
                        <tbody>
                        	<c:forEach var="offer" items="${offerDetail}">
								<c:set var="id" value="${offer.id}"/>
								<c:set var="offerId" value="${offer.offerId}"/>
								<c:set var="name" value="${offer.name}"/>
                                ...
                                <tr class = "tableRow">
                                    ...
                                    <td class="tr1"	>	
                                    	<c:url value="deleteOffer.jsp" var="offerDelete">
											<c:param name="id" value="${id}"/>
											<c:param name="offerId" value="${offerId}"/>
											<c:param name="name" value="${name}"/>
											<c:param name="desc" value="${desc}"/>
