...
<div class = "container">
		...
		<div class = "card special-card text-light">
			<div class = "card-body">
					<form action="otRetrieve" method ="post" >
					...
					<div class = "form-group col-lg-4">
						<button  type="submit" name ="updateStaff" value = "Update profile" class="btn-sm btn-primary btn-block "><i class="fas fa-eye"></i>  View OT History </button>		
					</div>
					<div class = "form-group col-lg-4">
         ...
         <c:forEach var="staffOT" items="${listStaffOT}">
                                ...
                                <tr class = "tableRow">
                                 	<td>
                                        <div class = "tableRowww">
                                               ${staffOT.staffFirstName}
                                        </div>    
                                    </td>
                                    <td>
                                        <div class = "tableRowww">
                                               ${staffOT.staffLastName}
                                        </div>    
                                    </td>
                                    <td>
                                        <div class = "tableRowww">
