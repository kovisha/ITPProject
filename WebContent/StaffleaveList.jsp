...
<div class = "container">
		...
		<!-- Start Leave selection month and year card -->
...
<div class = "container">
		...
		<div class = "card special-card text-light">
			<div class = "card-body">
					<form action="leaveRetrieve" method ="post" >
					...
					<div class = "form-group col-lg-4">
						<button  type="submit" name ="updateStaff" value = "Update profile" class="btn-sm btn-primary btn-block "><i class="fas fa-eye"></i> View Staff Leave History</button>		
					</div>
					<div class = "form-group col-lg-4">
			...
			<!-- End Leave selection month and year card -->

			<!-- Start leave list display table -->
         <table class = "table table-hover table-dark table-bordered table-sm text-center table-stripped">
         ...
         <!-- Retrieve all values which are coming from the StaffLeaveListServlet -->
         
         <c:forEach var="staffLeave" items="${listStaffLeave}">
                                ...
                                <tr class = "tableRow">
                                 	<td>
                                        <div class = "tableRowww">
                                               ${staffLeave.staffFirstName}
                                        </div>    
                                    </td>
                                    <td>
                                        <div class = "tableRowww">
                                               ${staffLeave.staffLastName}
                                        </div>    
                                    </td>
                                    <td>
                                        <div class = "tableRowww">
                                    ...
                                    <td>
                                        <div class = "tableRowww">
                                               ${staffLeave.leaveMonth}
                                        </div>    
                                    </td>
                                    <td>
                                        <div class = "tableRowww">
                                               ${staffLeave.workingDays}
                                        </div>    
                                    </td>
                                    <td>
                                        <div class = "tableRowww">
                                               ${staffLeave.totLeaveDays}
                                        </div>    
                                    </td>
                                    <td>
                                        <div class = "tableRowww">
                                               ${staffLeave.totHalfDays}
                                        </div>    
                                    </td>
